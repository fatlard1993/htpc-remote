...
const htpcRemote = {
	init: function(opts){
		...
		if(fs.existsSync(this.rootPath('node_modules/keyboard/src/fonts'))) app.use('/fonts', staticServer(this.rootPath('node_modules/keyboard/src/fonts')));

		else if(fs.existsSync(this.rootPath('../node_modules/keyboard/src/fonts'))) app.use('/fonts', staticServer(this.rootPath('../node_modules/keyboard/src/fonts')));
